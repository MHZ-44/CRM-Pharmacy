      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex gap-4">
          <Link
            ...
            className="rounded-2xl border border-yellow-300 bg-yellow-100 px-5 py-4 text-center shadow-md transition hover:scale-105 hover:shadow-xl dark:border-yellow-500/30 dark:bg-yellow-500/10 dark:shadow-none"
          >
          ...
          <Link
            ...
            className="rounded-2xl border border-red-300 bg-red-100 px-5 py-4 text-center shadow-md transition hover:scale-105 hover:shadow-xl dark:border-red-500/30 dark:bg-red-500/10 dark:shadow-none"
          >
